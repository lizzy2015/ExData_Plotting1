...
par(mfrow=c(2,2))
#first plot
plot(da$Time , da$Global_active_power, type="l", xlab="", ylab="Global Active Power")

#second plot
plot(da$Time , da$Voltage, type="l", xlab="datetime", ylab="Vlotage")

#third plot
plot(da$Time , da$Sub_metering_1, type="l", xlab="", ylab="Energy sub metering", col="black")
...
#fourth plot
plot(da$Time , da$Global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power")
